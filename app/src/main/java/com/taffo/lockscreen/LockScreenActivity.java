...
public class LockScreenActivity extends AppCompatActivity {
    ...
    This condition, on some devices, bypasses this occurrence by keeping the activity in the foreground*/
    @Override
    ...
    final List<Integer> notesColor = new ArrayList<>(NOTES);
    final StringBuilder coloredStringTv = new StringBuilder();
    private void unlock() {
